...
- `LS400Toolbox-Android-v1.2.0.apk` — expanded native Android/OpenGL ES build with 49 selectable components, 16 solid routed systems, dense service-recognition geometry, saved cameras, and onboard photo comparison. No WebView, browser, private server, internet permission, or network dependency.
...
Drag to orbit, pinch to zoom, double-tap to reset, and tap a modeled component to identify it. Use Full Car, A/C System, High Side, and Low Side to isolate service routes. Saved views cover the full vehicle, engine bay, compressor and HVAC cutaway; Reference displays the supplied hood-open photograph beside the live native model.
